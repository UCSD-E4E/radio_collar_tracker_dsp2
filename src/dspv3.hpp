...
namespace RCT
{
    ...
    public:
        ...
        void startProcessing(std::queue<std::complex<double> *> &inputQueue,
                             ...
                             std::queue<RCT::PingPtr> &outputQueue,
    ...
    private:
         ...
         * @param run Run flag
         */
        void _unpack(std::queue<std::complex<double> *> &i_q,
                     std::mutex &i_m,
        ...
        max(boost::circular_buffer<std::shared_ptr<std::vector<double>>> &sig) const;
         ...
         */
        std::vector<double> *
        sig_median(boost::circular_buffer<std::shared_ptr<std::vector<double>>> &sig) const;
         ...
         */
        std::shared_ptr<std::vector<bool>> compare(const std::vector<double> &data,
         ...
         */
        std::shared_ptr<std::set<std::size_t>> has_falling_edge(
